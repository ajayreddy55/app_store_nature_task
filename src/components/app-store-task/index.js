...
const tabsList = [
  ...
  const AppStore = () => {
    ...
    const getFilteredList = () => {
        return (appsList.filter(eachApp => eachApp.appName.toLowerCase().includes(searchInput.toLowerCase())
        ...
        <div className="app-store-bg">
            ...
            <ul className="app-store-tabs-list-container">
                {tabsList.map(eachTab => (
                    <TabItem key={eachTab.tabId} tabItem={eachTab} changeActiveTab={changeActiveTab}
